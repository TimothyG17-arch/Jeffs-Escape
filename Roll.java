...
public class Roll // the purpose of roll is for the randomized attack damage done by you and your opponent
{
    ...
    public void Dice() // the dice will have values from 1-20 and have breakpoints at 1-5, 6-10, 11-15, 16-20 that determine how much damage you or the enemy will do on your attack
    {
        int low = 1;
        int high = 21;
